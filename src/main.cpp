...
uint256 hashGenesisBlock("0xf2b553143c9589acc01ea0651a8621027e7aa560b798337a92544d125a732602");
...
static const int64 nTargetSpacing = 60; // barcoin: 2 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Today is April 1 2013, Article: Who is Satoshi Nakamoto?, Source: CoinDesk.com";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1399198883; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3422423;

        if (fTestNet)
        {
            block.nTime    = 1399198883;
            block.nNonce   = 440824;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x58500bd05a0ec937e580fa3b1d24007214f75645bbf2d2e7058cd23dd06bac14"));
